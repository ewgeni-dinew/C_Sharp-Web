        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Garments_GarmentCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                name: "GarmentSpecifications",
                columns: table => new
                {
                    GarmentId = table.Column<int>(nullable: false),
                    GarmentSizeId = table.Column<int>(nullable: false),
                    Quantity = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GarmentSpecifications", x => new { x.GarmentSizeId, x.GarmentId });
                    table.ForeignKey(
